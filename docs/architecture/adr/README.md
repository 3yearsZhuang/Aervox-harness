...
ADR 记录难以逆转、影响多个模块或改变数据/运维边界的技术决策。编号一经分配不复用；被替代时保留原文并标记 `Superseded by ADR-###`。
...
| ADR-014 | Proposed | 人格、Anthropic Skills、MCP 与 GPT-SoVITS 组合边界 | [ADR-014](ADR-014-persona-skills-mcp-voice.md) |
