...
| `CR-011` | [Agent Harness Loop 目标规范与迁移基线](reference/changes/CR-011-agent-harness-loop.md) | 2026-08-28 | Agent Loop、TurnAttempt、工具管线、Provider 或部署形态变更 | AVX-HAR-001、流式协议、能力组合、实现阶段或回滚边界不一致 |
