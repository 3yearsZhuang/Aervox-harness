...
| `ADR-014` | [人格/Skills/MCP/Voice 边界](architecture/adr/ADR-014-persona-skills-mcp-voice.md) | 技术负责人、安全/隐私负责人 | 2026-08-24 | Persona/Skill/MCP/Voice 契约或安全边界变更 | 三态语义、导出范围、凭据/权重边界与实现不一致 |
...
| `CR-001` | [人格插件 submodule 迁移变更](changes/CR-001-persona-plugin-submodule.md) | 技术负责人 | 2026-08-24 | 可选模块载体/指针/包边界变更 | CR 状态与 submodule、workspace 或模块清单不一致 |
...
| `AVX-MOD-PERSONA-001` | [`modules/persona-plugin`](https://github.com/KashiwagiEri233/aervox-persona-plugin-module) | Persona 模块负责人 | 2026-08-24 | 每次 submodule 指针/包契约/权限变更 | workspace 包、固定 commit 或模块自身 CI 不一致 |
