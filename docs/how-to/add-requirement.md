...
> 更新日期：2026-08-24  
> 状态：Draft  
> 关联：[需求追踪与交付基线](../reference/REQUIREMENTS_TRACEABILITY.md)

本指南回答“如何把一个 CAP 能力拆成可开发的原子需求，并通过 DoR 进入 Ready”。所有规则与字段以[追踪基线](../reference/REQUIREMENTS_TRACEABILITY.md)为准，本文件只给操作步骤。
