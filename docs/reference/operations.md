...
> 响应时限为草案默认值，正式生效需另行评审批准。

### 11.3 事件流程与交接

- 每次事件按升级矩阵指定处置、通信与记录分工；高严重度立即冻结发布（见 [§2 通用事件流程](#2-通用事件流程)）。
- 交接单至少包含：事件时间线、已做止损、剩余风险与待办。
...
| # | 演练项 | 通过标准 | 结果 PASS/FAIL | 账本水位/序列 | fail-closed 结果 | 偏差 | 改进项 |
|---|---|---|---|---|---|---|---|
