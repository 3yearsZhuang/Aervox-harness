...
| `CAP-016` | 自适应刷题与报告 | `P1 · R2` | `Mapped` | — | ✔ | [P1 验收原则](PRD.md#prd-cap-014-019)、[CR-019](changes/CR-019-deterministic-practice-guidance.md) | CR-019 已落地确定性练习反馈与下一轮建议（用时/提示数观测 + guidance 规则 + 报告展示）；仍补算法升级、冷启动策略和偏差评估并推进 `Specified` |
